...
describe('Core Ordering Interactions', () => {
  ...
  describe('ReelActionBar Add/Remove Button', () => {
    ...
    it('should display a different icon based on whether the item is in the cart', () => {
        const { rerender } = render(<ReelActionBar dish={MOCK_DISH} onFilterClick={() => {}} onDescriptionClick={() => {}} />);
        ...
        rerender(<ReelActionBar dish={MOCK_DISH} onFilterClick={() => {}} onDescriptionClick={() => {}} />);
