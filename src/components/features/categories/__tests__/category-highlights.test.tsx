...
const MOCK_DISHES_NO_SPECIALS: Dish[] = [
  { id: '1', name: 'Burger', category: 'Burgers', price: 10, veg: 'non-veg', image: '', instock: 'yes', description: '' },
  { id: '2', name: 'Pizza', category: 'Pizza', price: 12, veg: 'veg', image: '', instock: 'yes', description: '' },
];

const MOCK_DISHES_WITH_SPECIALS: Dish[] = [
  { id: '1', name: 'Special Burger', category: 'Burgers', price: 10, veg: 'non-veg', image: '', instock: 'yes', tag: 'bestseller', description: '' },
  { id: '2', name: 'Pizza', category: 'Pizza', price: 12, veg: 'veg', image: '', instock: 'yes', description: '' },
];
