    ...
    <section className="py-20 bg-[#FEF3E2]">
      <div className="container mx-auto text-center">
        <h2 className="text-3xl font-bold text-[#0B0B0B] mb-4">
          Go Premium, Unlock Growth
        </h2>
        <p className="text-xl text-muted-foreground mt-2 mb-12">
          Step up from Google Sheets to a powerful, in-app dashboard. Manage
        ...
        >
          <div className="text-left text-white">
            <h3 className="text-3xl font-bold mb-4">
              In-App Management Dashboard
            </h3>
            <p className="text-lg text-neutral-400 mb-6">
              Full control over your menu, brand, and daily status with an
              intuitive dashboard. No more switching between apps.
            </p>
            ...
            <ShineBorder className="w-fit" shineColor={['#FAB12F', '#FFC857']}>
