...
export function LoginFormContent({ onLoginSuccess, onLoginError, onClose }: LoginFormContentProps) {
  ...
  return (
    <div className="p-4">
      ...
      {error && onClose && ( // Only show close button if there's an error and onClose is provided
